...
const AddCategory = () => {
    ...
    const warningMessage = () => {
        if(error){
            return <h4 className="text-error"> Category created failed</h4>
        }
    ...
    return (
        <Base className="container bg-info p-4" title="Create Category Here" description="add category for new tshirts">
