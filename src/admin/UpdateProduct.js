...
const UpdateProduct=  ({match}) =>{
    ...
    const successMessage = ()=>(
        <div className="alert alert-success mt-2" style={{display: createdProduct?"":"none"}}>
            <h4>{createdProduct} created success </h4>
        </div>
    )
    const warningMessage = ()=>(
        <div className="alert alert-warning mt-2" style={{display: error?"":"none"}}>
